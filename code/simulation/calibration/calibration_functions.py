...
def get_epi_params():
    ...
    # and variances
    # exposure_duration = [6.8, 2.75] / days
    # time_until_symptoms = [6.3, 0.95] / days
    # infection_duration = [8.65, 4.75] / days
    # which result in the following true parameter values for a left-truncated
    # parameter selection process
    # exposure_duration = [4.83, 1.56] / days
    # time_until_symptoms = [6.48, 0.91] / days
    # infection_duration = [10.99, 3.87] / days
    epi_params = {
        'exposure_duration': [2.662794506920476, 7.6501507255486025],
        'time_until_symptoms': [7.862375357983137, 6.695392007737956],
        'infection_duration': [1.8935596294478323, 9.746904881250568]}  
